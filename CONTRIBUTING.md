Contributing to Thana
============================

The Thana project operates an open contributor model where anyone is
...
The following applies to code changes to the Thana project, and is not to be
confused with overall THANA Network Protocol consensus changes.

Whether a pull request is merged into Thana rests with the project merge
...
Patches that change THANA consensus rules are considerably more involved than
...
Where a patch set proposes to change the THANA consensus, it must have been
...
The project leader is the release manager for each Thana release.
