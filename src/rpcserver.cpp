...
static const CRPCCommand vRPCCommands[] =
    {
        ...
        /* Thana features */
        {"thana", "masternode", &masternode, true, true, false},
        {"thana", "listmasternodes", &listmasternodes, true, true, false},
        {"thana", "getmasternodecount", &getmasternodecount, true, true, false},
        {"thana", "masternodeconnect", &masternodeconnect, true, true, false},
        {"thana", "masternodecurrent", &masternodecurrent, true, true, false},
        {"thana", "masternodedebug", &masternodedebug, true, true, false},
        {"thana", "startmasternode", &startmasternode, true, true, false},
        {"thana", "createmasternodekey", &createmasternodekey, true, true, false},
        {"thana", "getmasternodeoutputs", &getmasternodeoutputs, true, true, false},
        {"thana", "listmasternodeconf", &listmasternodeconf, true, true, false},
        {"thana", "getmasternodestatus", &getmasternodestatus, true, true, false},
        {"thana", "getmasternodewinners", &getmasternodewinners, true, true, false},
        {"thana", "getmasternodescores", &getmasternodescores, true, true, false},
        {"thana", "mnbudget", &mnbudget, true, true, false},
        {"thana", "preparebudget", &preparebudget, true, true, false},
        {"thana", "submitbudget", &submitbudget, true, true, false},
        {"thana", "mnbudgetvote", &mnbudgetvote, true, true, false},
        {"thana", "getbudgetvotes", &getbudgetvotes, true, true, false},
        {"thana", "getnextsuperblock", &getnextsuperblock, true, true, false},
        {"thana", "getbudgetprojection", &getbudgetprojection, true, true, false},
        {"thana", "getbudgetinfo", &getbudgetinfo, true, true, false},
        {"thana", "mnbudgetrawvote", &mnbudgetrawvote, true, true, false},
        {"thana", "mnfinalbudget", &mnfinalbudget, true, true, false},
        {"thana", "checkbudgets", &checkbudgets, true, true, false},
        {"thana", "mnsync", &mnsync, true, true, false},
        {"thana", "spork", &spork, true, true, false},
        {"thana", "getpoolinfo", &getpoolinfo, true, true, false},
#ifdef ENABLE_WALLET
        {"thana", "obfuscation", &obfuscation, false, false, true}, /* not threadSafe because of SendMoney */
...
void StartRPCThreads()
{
    ...
    if (((mapArgs["-rpcpassword"] == "") ||
        ...
        uiInterface.ThreadSafeMessageBox(strprintf(
                                             _("To use thanad, or the -server option to thana-qt, you must set an rpcpassword in the configuration file:\n"
                                               "%s\n"
...
{
    return "> thana-cli " + methodname + " " + args + "\n";
}
...
std::string HelpExampleRpc(string methodname, string args)
{
    return "> curl --user myusername --data-binary '{\"jsonrpc\": \"1.0\", \"id\":\"curltest\", "
           "\"method\": \"" +
           methodname + "\", \"params\": [" + args + "] }' -H 'content-type: text/plain;' http://127.0.0.1:35611/\n";
}
