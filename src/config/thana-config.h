/* src/config/thana-config.h.  Generated from thana-config.h.in by configure.  */
/* src/config/thana-config.h.in.  Generated from configure.ac by autoheader.  */

#ifndef Thana_CONFIG_H

#define Thana_CONFIG_H
...
#define PACKAGE_BUGREPORT "thana.io"

/* Define to the full name of this package. */
#define PACKAGE_NAME "Thana Core"

/* Define to the full name and version of this package. */
#define PACKAGE_STRING "Thana Core 1.0.0"

/* Define to the one symbol short name of this package. */
#define PACKAGE_TARNAME "thana"
