...
/** Utility functions used by the THANA Qt UI.
 */
namespace GUIUtil
{
...
// Render THANA addresses in monospace font
...
// Parse "thana:" URI into recipient object, return true on successful parsing
