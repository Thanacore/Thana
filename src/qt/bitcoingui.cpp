...
void BitcoinGUI::createActions(const NetworkStyle* networkStyle)
{
    ...
    sendCoinsAction->setStatusTip(tr("Send coins to a THANA address"));
    ...
    receiveCoinsAction->setStatusTip(tr("Request payments (generates QR codes and thana: URIs)"));
    ...
    aboutAction = new QAction(networkStyle->getAppIcon(), tr("&About Thana"), this);
    aboutAction->setStatusTip(tr("Show information about Thana"));
    ...
    optionsAction->setStatusTip(tr("Modify configuration options for THANA"));
    ...
    signMessageAction->setStatusTip(tr("Sign messages with your THANA addresses to prove you own them"));
    verifyMessageAction = new QAction(QIcon(":/icons/transaction_0"), tr("&Verify message..."), this);
    verifyMessageAction->setStatusTip(tr("Verify messages to ensure they were signed with specified THANA addresses"));
    ...
    openAction->setStatusTip(tr("Open a THANA: URI or payment request"));

    showHelpMessageAction = new QAction(QApplication::style()->standardIcon(QStyle::SP_MessageBoxInformation), tr("&Command-line options"), this);
    showHelpMessageAction->setMenuRole(QAction::NoRole);
    showHelpMessageAction->setStatusTip(tr("Show the Thana help message to get a list with possible THANA command-line options"));
...
void BitcoinGUI::createTrayIcon(const NetworkStyle* networkStyle)
{
    ...
    QString toolTip = tr("Thana client") + " " + networkStyle->getTitleAddText();
...
void BitcoinGUI::setNumConnections(int count)
{
    ...
    labelConnectionsIcon->setToolTip(tr("%n active connection(s) to THANA network", "", count));
}
...
{
    QString strTitle = tr("Thana"); // default title
