...
In order to support loading of multiple wallets in thana-qt, a few changes in the UI architecture will be needed.
...
Only requiring some minor changes is thana.cpp.
...
Changes to thana.cpp
----------------------
thana.cpp is the entry point into thana-qt, and as such, will require some minor modifications to provide hooks for
