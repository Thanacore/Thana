Thana version 2.2.1 is now available from:

  <https://github.com/thanacoin/thana/releases>
...
Please report bugs using the issue tracker at github:
  ...
  <https://github.com/thanacoin/thana/issues>

Compatibility
==============

Thana is extensively tested on multiple operating systems using
...
Thana should also work on most other Unix-like systems but is not
...
of Bitcoin that THANA was forked from.
...
As well as everyone that helped translating on [Transifex](https://www.transifex.com/projects/p/thanacoin-translations/).
