...
RESOURCES += src/qt/thana.qrc src/qt/thana_locale.qrc

TRANSLATIONS += src/qt/locale/thana_bg.ts \
                src/qt/locale/thana_de.ts \
                src/qt/locale/thana_en.ts \
                src/qt/locale/thana_es.ts \
                src/qt/locale/thana_fi.ts \
                src/qt/locale/thana_fr.ts \
                src/qt/locale/thana_it.ts \
                src/qt/locale/thana_ja.ts \
                src/qt/locale/thana_pl.ts \
                src/qt/locale/thana_pt.ts \
                src/qt/locale/thana_ru.ts \
                src/qt/locale/thana_sk.ts \
                src/qt/locale/thana_sv.ts \
                src/qt/locale/thana_vi.ts \
                src/qt/locale/thana_zh_CN.ts \
                src/qt/locale/thana_zh_TW.ts
